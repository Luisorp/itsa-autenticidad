...
Route::middleware('auth')->group(function () {
    ...
    Route::resource('proyectos', ProyectoTitulacionController::class)->only(['create', 'store', 'edit', 'update'])->middleware(['auth', 'rol:administrador,docente']);
    ...
    Route::post('/proyectos/{proyecto}/analizar', [ProyectoTitulacionController::class, 'analizar'])->middleware(['auth', 'rol:administrador,docente'])->name('proyectos.analizar');
    Route::get('/proyectos/{proyecto}/analisis-externo', [AnalisisExternoController::class, 'show'])->middleware(['auth', 'rol:administrador,docente'])->name('proyectos.analisis-externo');
    Route::post('/proyectos/{proyecto}/analisis-externo', [AnalisisExternoController::class, 'analizar'])->middleware(['auth', 'rol:administrador,docente'])->name('proyectos.analisis-externo.analizar');
